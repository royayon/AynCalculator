...
public class Length1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggle = new ActionBarDrawerToggle(Length1.this, drawerLayout, toolbar,R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        ...
        equals.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    String calcType;
                    if(m2c){
                        calcType = " (Meters 2 Centimeters)";
                        reslt = .01 * input;
                    } else {
                        calcType = " (Centimeters 2 Meters)";
                        reslt = 100 * input;
                    }
                    int intres = (int) reslt;
                    String finalResult;
                    ...
                    try {
                        ...
                        dbM.writeDB();
                        Toast.makeText(Length1.this, "Stored in Database!", Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                        Toast.makeText(Length1.this, "Failed to Store in Database!", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
                    result.setText("Invalid Op!");
                }
